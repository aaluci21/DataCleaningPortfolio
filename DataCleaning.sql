...
From DataCleaning.dbo.NashvilleHousing
--here you will the address and city that is separated by a comma/delimiter

Select
	Substring(PropertyAddress, 1, CHARINDEX(',', PropertyAddress)-1) as Address
From DataCleaning.dbo.NashvilleHousing
--query no longer shows the comma after the address

Select
	Substring(PropertyAddress, 1, CHARINDEX(',',PropertyAddress) - 1)  AS Address, 
	Substring(PropertyAddress, CHARINDEX(',', PropertyAddress) + 1, LEN(PropertyAddress)) AS Address
From DataCleaning.dbo.NashvilleHousing
--query results two columns one with the address and the other with the city
